...
**Enrichments shipped (25/43):** ...+mem_network_connections ✅ | **Needs-fix NEW shipped (3/7):** file_carving, ntfs_objid, mem_extracted_pe_images ✅ (deferred: regedit_system_select)
