...
**Enrichments shipped (15/43):** fls, psort, run_mru, muicache, mountpoints2, shimcache, evtx_ntlm, windows_search_db_win11, wordwheel_query, mounted_devices, thumbcache, pca_general_db, usb_stor_enum, edge_webcache, windows_timeline ✅ (deferred: regedit_system_select)
