...
pub(crate) static VELOCIRAPTOR_FILE_V1_0_POWERSHELL_EXE: ArtifactDescriptor = ArtifactDescriptor {
    ...
    os_scope: OsScope::Win7Plus,
    decoder: Decoder::Identity,
    meaning: "Executes arbitrary commands through PowerShell with output capture
and upload support.
...
pub(crate) static VELOCIRAPTOR_FILE_LOGS_MICROSOFT_WINDOWS_POWERSHELL_4OPERATI: ArtifactDescriptor =
    ArtifactDescriptor {
        ...
        os_scope: OsScope::Win7Plus,
        decoder: Decoder::Identity,
        meaning: "Parses PowerShell script block logging entries (Event ID 4104) to
...
pub(crate) static VELOCIRAPTOR_FILE_: ArtifactDescriptor = ArtifactDescriptor {
    ...
    os_scope: OsScope::Win7Plus,
    decoder: Decoder::Identity,
    meaning: "Scans NTFS volumes for data hidden in Alternate Data Streams, using
...
pub(crate) static VELOCIRAPTOR_FILE_TASKS: ArtifactDescriptor = ArtifactDescriptor {
    ...
    os_scope: OsScope::Win7Plus,
    decoder: Decoder::Identity,
    meaning: "Enumerates Windows scheduled tasks and parses their XML definitions
...
each row, to aid analysis.",
    ...
    sources: &[
        "https://github.com/Velocidex/velociraptor",
        "https://github.com/EricZimmerman/KapeFiles/blob/master/Targets/$MFT.tkape",
    ],
    evidence_strength: None,
    evidence_caveats: &[],
    volatility: None,
...
pub(crate) static VELOCIRAPTOR_FILE_WINDOWS_SYSMON64_EXE: ArtifactDescriptor = ArtifactDescriptor {
    ...
    os_scope: OsScope::Win7Plus,
    decoder: Decoder::Identity,
    meaning: "Deploys Sysmon with a config file and ensures the Sysmon64 service
is running.
...
pub(crate) static VELOCIRAPTOR_FILE_TEMP_LOCALLOGS_LOG: ArtifactDescriptor = ArtifactDescriptor {
    ...
    os_scope: OsScope::Win7Plus,
    decoder: Decoder::Identity,
    meaning: "Fetches encrypted local log files from endpoints via the upload
function.
...
pub(crate) static VELOCIRAPTOR_FILE_LOG_WTMP: ArtifactDescriptor = ArtifactDescriptor {
    ...
    triage_priority: TriagePriority::Medium,
    related_artifacts: &[],
    sources: &["https://github.com/Velocidex/velociraptor", "https://github.com/libyal/dtformats/blob/main/documentation/Utmp%20login%20records%20format.asciidoc"],
    evidence_strength: None,
    evidence_caveats: &[],
    volatility: None,
    volatility_rationale: "",
